...
import org.dangcat.persistence.annotation.AfterCommit;
import org.dangcat.persistence.annotation.AfterDelete;
import org.dangcat.persistence.annotation.AfterInsert;
import org.dangcat.persistence.annotation.AfterLoad;
import org.dangcat.persistence.annotation.AfterSave;
import org.dangcat.persistence.annotation.BeforeDelete;
import org.dangcat.persistence.annotation.BeforeInsert;
import org.dangcat.persistence.annotation.BeforeSave;
...
public class EntityData
{
    ...
    public boolean equals(Object obj)
    {
        ...
        if (fieldG == null)
        {
            ...
            return false;
        if (!Arrays.equals(fieldH, other.fieldH))
            return false;
        return true;
    }
