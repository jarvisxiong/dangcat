...
@Table("AccountInfo")
@Sql("SELECT AccountInfo.Id, AccountInfo.Name, AccountInfo.GroupId, GroupInfo.Name GroupName, GroupInfo.Description GroupDescription, AccountInfo.ServiceId, ServiceInfo.Name ServiceName, ServiceInfo.Description ServiceDescription"
        + "\r\nFROM AccountInfo"
