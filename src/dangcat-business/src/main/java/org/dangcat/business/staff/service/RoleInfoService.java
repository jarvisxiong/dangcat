...
public interface RoleInfoService
{
     ...
     * @return 运行结果。
     */
    public RoleInfo create(@Parameter(name = "roleInfo") RoleInfo roleInfo) throws ServiceException;
     ...
     * @return 查询结果。
     */
    public QueryResult<RoleBasic> query(@Parameter(name = "roleInfoFilter") RoleInfoFilter roleInfoFilter) throws ServiceException;
     ...
     * @return 运行结果。
     */
    public RoleInfo save(@Parameter(name = "roleInfo") RoleInfo roleInfo) throws ServiceException;
     ...
     * @return 查询结果。
     */
    public Map<Integer, String> select(@Parameter(name = "roleInfoFilter") RoleInfoFilter roleInfoFilter) throws ServiceException;
     ...
     * @return 查看结果。
     */
    public RoleInfo view(@Parameter(name = "id") Integer id) throws ServiceException;
}
