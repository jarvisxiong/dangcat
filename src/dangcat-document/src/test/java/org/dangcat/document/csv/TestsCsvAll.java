...
public class TestsCsvAll
{
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("1,2");
    ...
    public void test10() throws Exception
    {
        ...
        CsvReader reader = CsvReaderUtils.parse(data);
    ...
    public void test118() throws Exception
    {
        ...
        String data = Charset.forName("ISO-8859-1").decode(ByteBuffer.wrap(buffer)).toString();
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("1,2\t3\tblah \"some stuff in quotes\"\t\'blah \'\'some stuff in quotes\'\'\'" + recordDelimiterText, data);
    }
    ...
    public void test119() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"1,2\",3" + recordDelimiterText + "1,2\t3" + recordDelimiterText, data);
    }
    ...
    public void test120() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"1,2\"" + recordDelimiterText, data);
        writer.close();
    }
    ...
    public void test121() throws Exception
    {
        ...
        String data = Charset.forName("ISO-8859-1").decode(ByteBuffer.wrap(buffer)).toString();
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("1,2" + recordDelimiterText + "1,2" + recordDelimiterText + "\" 1 \",2" + recordDelimiterText, data);
    }
    ...
    public void test122() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"1,2\",,\"3 \"" + recordDelimiterText, data);
    }
    ...
    public void test123() throws Exception
    {
        ...
        writer.setEscapeMode(UserSettings.ESCAPE_MODE_BACKSLASH);
        ...
        String data = Charset.forName("ISO-8859-1").decode(ByteBuffer.wrap(buffer)).toString();
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"#123\"" + recordDelimiterText + "\\#123" + recordDelimiterText + "\\#" + recordDelimiterText, data);
    }
    ...
    public void test131() throws Exception
    {
        ...
        String data = Charset.forName("ISO-8859-1").decode(ByteBuffer.wrap(buffer)).toString();
        Assert.assertEquals("1\\,\\\\\\\r\\\n2" + recordDelimiterText + "1\\,\\\\\\;2;", data);
    }
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("1\n\n1\r\r1\r\n\r\n1\n\r1");
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("1;; ;1");
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("\"" + generateString('a', 100001) + "\"");
        try
        {
            reader.readRecord();
        }
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("\"" + generateString('a', 100000) + "\"");
        Assert.assertTrue(reader.readRecord());
    ...
    public void test146() throws Exception
    {
        ...
        CsvReader reader = CsvReaderUtils.parse("\"" + generateString('a', 10000) + "\r\nb");
        Assert.assertEquals("", reader.getRawRecord());
    ...
    public void test147() throws Exception
    {
        ...
        CsvReader reader = CsvReaderUtils.parse(data.toString());
        reader.setUseTextQualifier(false);
        reader.setEscapeMode(UserSettings.ESCAPE_MODE_BACKSLASH);
        Assert.assertTrue(reader.readRecord());
    ...
    public void test34() throws Exception
    {
        ...
        Assert.assertEquals(1L, reader.getCurrentRecord());
        Assert.assertEquals(4, reader.getColumnCount());
        Assert.assertEquals("\"Samuel Barber\", \"Adagio for Strings\", \"Classical\", \"This field contains a double quote character, \"\", but it doesn't matter as it is escaped\"", reader
                .getRawRecord());
        Assert.assertFalse(reader.readRecord());
        reader.close();
    }
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("user_id,name\r\n1,Bruce");
        ...
        Assert.assertEquals(UserSettings.ESCAPE_MODE_DOUBLED, reader.getEscapeMode());
        reader.setEscapeMode(UserSettings.ESCAPE_MODE_BACKSLASH);
        Assert.assertEquals(UserSettings.ESCAPE_MODE_BACKSLASH, reader.getEscapeMode());
    ...
    public void test54() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"1,2\",3,\"blah \"\"some stuff in quotes\"\"\"" + recordDelimiterText + "\"1,2\",\"3\",\"blah \"\"some stuff in quotes\"\"\"", data);
    }
    ...
    public void test56() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("1,2\t3\t\"blah \"\"some stuff in quotes\"\"\"" + recordDelimiterText, data);
    }
    ...
    public void test58() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"data\r\nmore data\"\t3\t3\t\" 3\t\"" + recordDelimiterText, data);
    }
    ...
    public void test71() throws Exception
    {
        ...
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("\"data\"" + recordDelimiterText, data);
    }
    ...
    public void test73() throws Exception
    {
        ByteArrayOutputStream stream = new ByteArrayOutputStream();
        CsvWriter writer = new CsvWriter(stream, ',', Charset.forName("ISO-8859-1"));
        Assert.assertEquals(UserSettings.ESCAPE_MODE_DOUBLED, writer.getEscapeMode());
        writer.setEscapeMode(UserSettings.ESCAPE_MODE_BACKSLASH);
        Assert.assertEquals(UserSettings.ESCAPE_MODE_BACKSLASH, writer.getEscapeMode());
        writer.write("1,2");
        writer.write("3");
        writer.write("blah \"some stuff in quotes\"");
        writer.endRecord();
    ...
    public void test75() throws Exception
    {
        ...
        String data = Charset.forName("ISO-8859-1").decode(ByteBuffer.wrap(buffer)).toString();
        String recordDelimiterText = writer.getRecordDelimiterText();
        Assert.assertEquals("1" + recordDelimiterText + "#blah" + recordDelimiterText + "2" + recordDelimiterText, data);
    }
    ...
    {
        CsvReader reader = CsvReaderUtils.parse("1,Bruce");
        Assert.assertTrue(reader.readRecord());
    ...
    public void test79()
    {
        CsvReader reader = CsvReaderUtils.parse("");
        reader.close();
        try
        {
            reader.readRecord();
    ...
    public void test82() throws Exception
    {
        ...
        CsvReader reader = CsvReaderUtils.parse(holder.toString());
        try
        {
            reader.readRecord();
        }
        catch (Exception ex)
        {
            assertException(new IOException(
                    "Maximum column count of 100,000 exceeded in record 0. Set the SafetySwitch property to false if you're expecting more than 100,000 columns per record to avoid this error."), ex);
        }
        reader.close();
    }
